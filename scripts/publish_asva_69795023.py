...
p=requests.get(f"{API}/products/MLM69795023",headers=H,timeout=10).json()
print(f"Product MLM69795023: '{p.get('name')}' domain={p.get('domain_id')}")

pi=requests.get(f"{API}/products/MLM69795023/items?limit=10",headers=H,timeout=10).json()
...
payload={
    ...
    "condition":"new","catalog_product_id":"MLM69795023","catalog_listing":True,
}
print(f"\nPublicando a $798")
