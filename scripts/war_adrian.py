#!/usr/bin/env python3
"""War Adrian (AH) V5 — DINAMICO + pulido.
Cambios vs v4:
...
print(f"war-adrian-v5: descubiertos={len(ids)} | WIN={stat['win']} COMP(fix)={stat['comp']} REINDEX={stat['reindex']} LOCKED={stat['locked']} sin_cpid={stat['nocpid']} ERR={stat['err']}")
