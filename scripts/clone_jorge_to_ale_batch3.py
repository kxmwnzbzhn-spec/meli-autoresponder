#!/usr/bin/env python3
"""Clone the third three Jorge catalog listings to Alejandra, idempotently."""
import json, os, requests

API = "https://api.mercadolibre.com"
SOURCE_IDS = ["MLM3402390259", "MLM3403240547", "MLM3403241131"]
...
print("ALE_BATCH3_RESULTS=" + json.dumps(results, ensure_ascii=False), flush=True)
