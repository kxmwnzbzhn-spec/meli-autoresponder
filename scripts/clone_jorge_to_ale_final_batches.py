#!/usr/bin/env python3
"""Clone the all remaining Jorge catalog listings to Alejandra, idempotently."""
import json, os, requests

API = "https://api.mercadolibre.com"
SOURCE_IDS = ["MLM6100171026", "MLM6130882372", "MLM6130980192", "MLM6145816666"]
...
print("ALE_FINAL_BATCHES_RESULTS=" + json.dumps(results, ensure_ascii=False), flush=True)
