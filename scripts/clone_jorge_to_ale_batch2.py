#!/usr/bin/env python3
"""Clone the second three Jorge catalog listings to Alejandra, idempotently."""
import json, os, requests

API = "https://api.mercadolibre.com"
SOURCE_IDS = ["MLM3401303117", "MLM3402363017", "MLM3402386723"]
...
print("ALE_BATCH2_RESULTS=" + json.dumps(results, ensure_ascii=False), flush=True)
