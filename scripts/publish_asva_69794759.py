...
p=requests.get(f"{API}/products/MLM69794759",headers=H,timeout=10).json()
print(f"Product MLM69794759: '{p.get('name')}' domain={p.get('domain_id')}")

pi=requests.get(f"{API}/products/MLM69794759/items?limit=10",headers=H,timeout=10).json()
...
payload={
    ...
    "condition":"new","catalog_product_id":"MLM69794759","catalog_listing":True,
}
print(f"\nPublicando a $798")
