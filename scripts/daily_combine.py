...
def main():
    ...
    accounts = ["Claribel", "Asva", "Adrian", "Mayrely"]
    artifact_map = {"Claribel": "Claribel", "Asva": "Asva", "Adrian": "Ah", "Mayrely": "Mc"}
    file_map     = {"Claribel": "CLARIBEL", "Asva": "ASVA", "Adrian": "AH", "Mayrely": "MC"}
    for acc in accounts:
