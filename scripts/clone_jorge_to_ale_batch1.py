#!/usr/bin/env python3
"""Clone the first three Jorge catalog listings to Alejandra, idempotently."""
import json, os, requests

API = "https://api.mercadolibre.com"
SOURCE_IDS = ["MLM3401279297", "MLM3401288599", "MLM3401292527"]
...
print("ALE_BATCH1_RESULTS=" + json.dumps(results, ensure_ascii=False), flush=True)
