#!/usr/bin/env python3
"""Clone the fifth three Jorge catalog listings to Alejandra, idempotently."""
import json, os, requests

API = "https://api.mercadolibre.com"
SOURCE_IDS = ["MLM3422525901", "MLM3422645551", "MLM6097030480"]
...
print("ALE_BATCH5_RESULTS=" + json.dumps(results, ensure_ascii=False), flush=True)
