#!/usr/bin/env python3
"""Clone the seventh three Jorge catalog listings to Alejandra, idempotently."""
import json, os, requests

API = "https://api.mercadolibre.com"
SOURCE_IDS = ["MLM6099889822", "MLM6100157520", "MLM6100158830"]
...
print("ALE_BATCH7_RESULTS=" + json.dumps(results, ensure_ascii=False), flush=True)
