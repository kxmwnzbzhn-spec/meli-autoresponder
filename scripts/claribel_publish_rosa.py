#!/usr/bin/env python3
"""3 catálogos JBL Go 4 ROSA en Claribel."""
import os, requests, json, time
APP_ID = os.environ["MELI_APP_ID"]; APP_SECRET = os.environ["MELI_APP_SECRET"]
RT = os.environ["MELI_REFRESH_TOKEN_CLARIBEL"]
CATALOGS = ["MLM45530822","MLM45700101","MLM65831856"]
PRICE=499.0; QTY=1; CAT="MLM59800"; LINE="Catalog-Claribel-Rosa"; DELAY=8
...
for p in published: print(f"  {p['iid']} ← {p['cpid']} | {p['title'][:40]}")
