...
ACCOUNTS = [
    # ("JUAN", "MELI_REFRESH_TOKEN"),  # DEACTIVATED 2026-07-28 (user pidió solo ASVA)
    ...
    # ("MAYRELY", "MELI_REFRESH_TOKEN_MAYRELY"),  # DESACTIVADO 2026-07-03 por directiva usuario
    ...
    # ("KARIME", "MELI_REFRESH_TOKEN_KARIME"),  # DEACTIVATED 2026-07-28 (user pidió solo ASVA)
    # ("LIGIA", "MELI_REFRESH_TOKEN_LIGIA"),  # DEACTIVATED 2026-07-28 (user pidió solo ASVA)
]
