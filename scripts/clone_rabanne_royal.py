"""Clone MLM2969851513 (Rabanne 1 Million Royal 100ml) as tradicional in Adrián at $1999."""
...
TITLE="Rabanne 1 Million Royal Parfum 100ml Hombre"  # 43 chars

ATTRS=[
    {"id":"BRAND","value_name":"Rabanne"},
    {"id":"GTIN","value_name":"3349668610150"},
    {"id":"PERFUME_NAME","value_name":"1 Million Royal"},
    {"id":"PERFUME_TYPE","value_name":"Eau de parfum"},
    {"id":"UNIT_VOLUME","value_name":"100 mL"},
    {"id":"GENDER","value_name":"Hombre"},
    {"id":"ITEM_CONDITION","value_name":"Nuevo"},
    {"id":"MODEL","value_name":"1 Million Royal"},
]
...
if proceed:
    ...
    if rp.status_code in (200,201):
        ...
        requests.post(f"{SBU}/rest/v1/meli_actions_log",headers=SBH,
            json={"account":"ADRIAN","item_id":iid,"action_type":"clone_rabanne_royal",
                  "from_value":SRC,"to_value":f"{iid} brand=Rabanne price=1999",
                  "actor":"claude_cowork",
                  "details":"clone tradicional Rabanne 1 Million Royal brand original"},timeout=10)
    else:
