...
# Batch 5: posiciones 21-25
SOURCES = [
    "MLM2891178563",  # 2 sold (Rojo)
    "MLM5246077488",  # 2 sold (Azul)
    "MLM2904767723",  # 2 sold (Azul/Negro)
    "MLM2891178603",  # 1 sold (Rojo)
    "MLM5246052052",  # 1 sold (Azul Marino)
]
PRICE = 449
VISIBLE_QTY = 1
