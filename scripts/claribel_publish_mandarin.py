#!/usr/bin/env python3
"""6 catálogos Armaf Odyssey Mandarin Sky en Claribel."""
import os, requests, json, time
APP_ID = os.environ["MELI_APP_ID"]; APP_SECRET = os.environ["MELI_APP_SECRET"]
RT = os.environ["MELI_REFRESH_TOKEN_CLARIBEL"]
CATALOGS = [
    "MLM46926154",  # Mandarin Sky 60ml
    "MLM63357676",  # Mandarin Sky Limited Edition 100ml
    "MLM65066279",  # Mandarin Sky Limited Arabes 100ml
    "MLM66233752",  # Mandarin Sky Elixir 100ml
    "MLM22299658",  # Mandarin Sky Limited Edition 100ml (alt)
    "MLM53673404",  # Hombre Mandarin Sky 100ml
]
PRICE=499.0; QTY=1; CAT="MLM1271"; LINE="Catalog-Claribel-MandarinSky"; DELAY=8
