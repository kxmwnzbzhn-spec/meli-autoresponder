#!/usr/bin/env python3
"""Clone the sixth three Jorge catalog listings to Alejandra, idempotently."""
import json, os, requests

API = "https://api.mercadolibre.com"
SOURCE_IDS = ["MLM6097038456", "MLM6097051040", "MLM6098727716"]
...
print("ALE_BATCH6_RESULTS=" + json.dumps(results, ensure_ascii=False), flush=True)
