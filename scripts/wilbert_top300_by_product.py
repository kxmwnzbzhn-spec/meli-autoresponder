...
with open("ETIQUETAS_WILBERT_TOP300_BY_PRODUCT.pdf","wb") as f: writer.write(f)
print(f"\n✅ PDF: ETIQUETAS_WILBERT_TOP300_BY_PRODUCT.pdf ({len(writer.pages)} págs) | Fallidas: {len(fail)}")
