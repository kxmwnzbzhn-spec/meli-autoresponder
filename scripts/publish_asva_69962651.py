...
p=requests.get(f"{API}/products/MLM69962651",headers=H,timeout=10).json()
print(f"Product MLM69962651: '{p.get('name')}' domain={p.get('domain_id')}")

pi=requests.get(f"{API}/products/MLM69962651/items?limit=10",headers=H,timeout=10).json()
...
payload={
    ...
    "condition":"new","catalog_product_id":"MLM69962651","catalog_listing":True,
}
print(f"\nPublicando a $798")
