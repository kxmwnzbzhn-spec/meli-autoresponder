...
TOP_N = 300  # tomar primeras N por handling_limit ASC (más urgentes/atrasadas primero)
...
# Re-ordena dentro del top por (handling_limit, producto) para picking
...
with open("ETIQUETAS_WILBERT_TOP300.pdf","wb") as f: writer.write(f)
print(f"\n✅ PDF: ETIQUETAS_WILBERT_TOP300.pdf ({len(writer.pages)} págs) | Fallidas: {len(fail)}")
